...
public class MechanicalKeyboard implements KeyListener 
{
    ...
    private static final String[] keyPressFilePaths = { "CherryBlueKeyPress.wav", "CherryBrownKeyPress.wav", "CherryBlueKeyRelease.wav", "CherryBrownKeyRelease.wav" };
    private static final String[] keyReleaseFilePaths = { "CherryBlueKeyRelease.wav", "CherryBrownKeyRelease.wav", "CherryBlueKeyPress.wav", "CherryBrownKeyPress.wav" };
    ...
    public static void mechanicalKeyboard() 
    {
        for(int i = 0; i < keyPressFilePaths.length; ++i) { keyPressFilePaths[i] = "resources/sounds/Key-Sounds/" + keyPressFilePaths[i]; }
        for(int i = 0; i < keyReleaseFilePaths.length; ++i) { keyReleaseFilePaths[i] = "resources/sounds/Key-Sounds/" + keyReleaseFilePaths[i]; }
